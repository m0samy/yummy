...
async function getCategories() {
    ...
    displayCategories(finalResult.categories)
    $(".inner-loading-screen").fadeOut(300)
}
function displayCategories(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
            <div onclick="filterCategoryMeals('${arr[i].strCategory}')" class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
            <div onclick="filterIngredientsMeals('${arr[i].strIngredient}')" class=" rounded-2 text-center cursor-pointer">
                <i class="fa-solid fa-drumstick-bite fa-3x colr"></i>
...
async function filterCategoryMeals(category) {
    $(".inner-loading-screen").fadeIn(300)
...
async function filterAreaMeals(area) {
    $(".inner-loading-screen").fadeIn(300)
...
function showSearchInputs() {
    ...
    <div class="row py-4">
    <div class="col-md-12">
        <input onkeyup="searchByName(this.value)" class="form-control bg-transparent  text-white" type="text"
...
async function searchByName(term) {
    ...
    finalResult.meals ? displayMeals(finalResult.meals) : displayMeals([])
    $(".inner-loading-screen").fadeOut(300)
}
//////////////////////////////////////////////////////////
...
function showContactUs() {
    ...
    <div class="container w-75 text-center">
        ...
        <button id="submitBtn" disabled type="submit" class="btn btn-outline-danger px-2 mt-3 ">Submit</button>
    </div>
</div>
